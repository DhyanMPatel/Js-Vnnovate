...
//   const item = window.localStorage.getItem("reportTable");
//   return item ? JSON.parse(item) : themeConfig.layout.reportTable;
// };

// const initialBrandName = () => {
//   const item = window.localStorage.getItem("brandName");
...
export const layoutSlice = createSlice({
  ...
  reducers: {
    ...
    handleBrandName: (state, action) => {
      ...
      // window.localStorage.setItem("brandName", JSON.stringify(action.payload));
    },
  },
});
